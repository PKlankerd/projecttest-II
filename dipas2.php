...
<body style="background-color:#c9e0f1; overflow:auto; ">
    ...
    <section class="home-section">
        <div class="home-content">
            ...
            <span class="text"><span>Welcome To </span>
            </span>
        </div>
        <div class="container" id="app">
            <div class=" home_content ">
                    ...
                    <div class="col-md-8  p-3  m-5  " style="float: center;  ">
                        <div class="col-12">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-md-12">
                                    <input type="text" name="runno_dip" v-model="RUNNER" id="run" class="form-control form-control-md"
                                        style="border-radius: 30px;" placeholder="เลข Dipping Lot " maxlength="3"
                                        autocomplete="off" required>
                                </div>
                                <div class="col-lg-6">
                            <button class="btn btn-primary btn-lg " type="button" name="diplot" id="gen" @click="generate" style="float: right;">Gen</button>
                            </div>
                ...
                <div class="table-responsive-lg">
                    ...
                    <div class="col-lg-6">
                            <button class="btn btn-primary btn-lg " type="submit" name="saveas2" @click="sendata" style="float: right;">Save</button>
                        </div>
